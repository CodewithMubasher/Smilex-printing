            ...
            <div className="flex flex-col max-w-5xl mx-auto gap-6 sm:gap-8">
              <div className="relative flex flex-col text-center items-center sm:gap-6 gap-4">
                ...
                <motion.p
                  ...
                  className="text-sm sm:text-base font-normal max-w-2xl text-muted-foreground"
                >
                  We provide high-quality digital printing and creative design solutions to help businesses and individuals bring their ideas to life. From custom prints and branding materials to eye-catching graphics, we deliver precision, quality, and creativity in every project.
                </motion.p>
              </div>
              <motion.div
                initial={{ opacity: 0, y: 32 }}
